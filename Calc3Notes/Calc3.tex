...
$\nabla f = \mathbf{0}$. $f$ has a critical point if $f_x(a,b)=0$ or $f_y(a,b)$
...
\noindent Visually: 
\begin{center}
    \includegraphics[width=12cm,height=12cm, keepaspectratio]{LagrangeMultiplier.png}
\end{center}
...
\begin{center}
    \includegraphics[width=12cm,height=12cm, keepaspectratio]{TwoConstantLagrangeMultiplier.png}
\end{center}
Therefore, 
